package com.Tinaio.nfcreaderandwriter
            ...
            if (NfcAdapter.ACTION_TECH_DISCOVERED == intent.action
                ...
                if (ndef.isWritable) {
                    ...
                    var message = NdefMessage(
                        arrayOf(
                            NdefRecord.createTextRecord("fa", "Nima"),
                            NdefRecord.createTextRecord("fa", "Abdpoor"),
                            NdefRecord.createTextRecord("fa", "123456789")
                        )
                    )
                    ndef.connect()
